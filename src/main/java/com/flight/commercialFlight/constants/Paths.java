...
public class Paths {
    ...
    public static final String FETCH_FLIGHT_ID = "/flight/fetchDetails/{flight_id}";
    public static final String FETCH_FLIGHT_ALL = "/flight/fetchDetails";
    public static final String FETCH_PASENG_ID = "/passenger/fetchDetails/{passengerNum}";
